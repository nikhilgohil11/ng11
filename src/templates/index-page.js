              ...
              <div className="columns is-vcentered">
                <div className="column has-text-centered">
                  ...
                  <div className="subtitle has-numbers">
                    <span className="tag">{totalStories}</span> Stories & Blogs, <span className="tag">{totalVideos}</span> Tutorials & Videos
                    and <span className="tag">{totalServices}</span> Tools & Services
                  </div>
                </div>
              </div>
            </div>
